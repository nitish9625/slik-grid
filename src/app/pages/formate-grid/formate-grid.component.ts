...
import { AngularGridInstance,FieldType, Formatter, Formatters, GridOption, Column, OnEventArgs,
  AutocompleteOption,
  ...
  SlickGrid,
  SlickNamespace,
  SortComparers, } from 'angular-slickgrid';
...
@Component({
  selector: 'app-formate-grid',
  templateUrl: './formate-grid.component.html',
  styleUrls: ['./formate-grid.component.css']
})
export class FormateGridComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.columnDefinitions = [
      ...
      {
          id:'edit', name:'Action', field:'action', excludeFromHeaderMenu:true, formatter:Formatters.editIcon, minWidth:30, maxWidth:30,
          onCellClick:(e: Event, args:OnEventArgs)=>{
            
          }
      },
      {id:'id', field:'id', excludeFromHeaderMenu: true, formatter: Formatters.deleteIcon, minWidth: 30, maxWidth: 30,
    onCellClick: (e: Event, args:OnEventArgs)=>{
      console.log(args);
      if(confirm('Are you really want to delete row')){

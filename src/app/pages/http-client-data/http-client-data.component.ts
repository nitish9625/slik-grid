...
import { GridOption, AngularGridInstance, Column, Filters} from 'angular-slickgrid';

const URL_CUSTOMERS = '/assets/data/collection_100_number.json';

@Component({
  selector: 'app-http-client-data',
